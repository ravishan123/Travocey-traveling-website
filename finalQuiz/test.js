...
function showResult(){
    ...
    scoreBoard.style.gridTemplateRows="auto auto auto";
...
//     }
// }
// function timeUpdate(deadline,end) {
...
// //timer
// function timer() {
//     var deadline = new Date().getTime() + 1000 * 60;
//     console.log(action);
//     var x = setInterval(timeUpdate(deadline,false), 1000);
// }